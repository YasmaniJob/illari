...
import { clearAuthCache } from '@/shared/client/api-client';
    ...
    <>
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button
          ...
          className="flex items-center justify-center gap-1.5 rounded-xl bg-coral-500 text-white hover:bg-coral-600 border border-coral-600 transition-all active:scale-[0.98] focus-ring-warm p-2 sm:py-2 sm:px-4"
          title="Registrarse"
      ...
      {/* Modal — se monta sobre la página actual, sin navegación */}
