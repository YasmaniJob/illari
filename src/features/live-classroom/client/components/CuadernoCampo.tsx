...
function buildFichasIndividuales(messages: ChatMessage[], session: SessionConfig): FichaIndividual[] {
        ...
        return (
          <Page key={ficha.id} size="A4" style={S.page}>
            ...
            <View style={{ marginTop: 10 }}>
              <Text style={{ fontFamily: 'Helvetica-Bold', fontSize: 9, marginBottom: 3 }}>1. SITUACIÓN OBSERVADA</Text>
              <Text style={{ fontFamily: 'Helvetica-Oblique', fontSize: 8, color: '#666', marginBottom: 5 }}>
                ¿Qué hace el niño(a)? ¿Cómo interactúa con objetos, el espacio y las personas? (Describir sin
                interpretar)
              </Text>
              <View
                style={{ borderWidth: 1, borderColor: '#111', paddingHorizontal: 6, paddingVertical: 5, minHeight: 60 }}
              >
            ...
            <View style={{ marginTop: 10 }}>
              <Text style={{ fontFamily: 'Helvetica-Bold', fontSize: 9, marginBottom: 3 }}>2. ANÁLISIS PEDAGÓGICO</Text>
              ...
              <View
                style={{ borderWidth: 1, borderColor: '#888', paddingHorizontal: 6, paddingVertical: 5, minHeight: 36 }}
              >
                <Text style={{ fontFamily: 'Helvetica-Bold', fontSize: 8, color: '#444', marginBottom: 3 }}>
...
function CuadernoCampo({ session, students, messages, onClose }: Props) {
  ...
  const fichas = buildFichasIndividuales(messages, session);
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr>
                    ...
                    <th className="border border-gray-700 px-3 py-2.5 text-center w-48 bg-gray-100">
                      RETROALIMENTACIÓN
                    </th>
                  </tr>
                </thead>
                  ...
                  return (
                    <div key={ficha.id} className="border-2 border-gray-200 rounded-xl p-5 bg-white shadow-sm">
                      <div className="flex items-center justify-between pb-2 mb-3 border-b border-gray-200">
                        <h3 className="text-base font-extrabold text-warm-900 capitalize">{ficha.studentName}</h3>
                      ...
                      <table className="w-full border-collapse text-sm mb-4">
                        <tbody>
                          <tr>
                            ...
                            <td className="border border-gray-700 px-2 py-1.5 text-sm">
                              {fecha} — {ficha.timestamp}
                            </td>
                          </tr>
                        </tbody>
                      ...
                      {/* Sección 1 */}
                      <div className="mb-4">
                        <p className="text-[11px] font-extrabold uppercase tracking-wider mb-1">
                          1. Situación observada
                        </p>
