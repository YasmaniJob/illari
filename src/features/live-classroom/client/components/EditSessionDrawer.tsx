...
import StudentsRosterInput from '@/features/class-preparation/client/components/StudentsRosterInput';
import type { CurriculumRow, SessionConfig } from '@/features/curriculum/curriculum';
import { getAreas, getCapacidades, getCompetencias } from '@/features/curriculum/curriculum';
import { fetchStudents, patchSession, type StudentDto } from '@/shared/client/api-client';
              ...
              <div className="px-5 pb-5 space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between gap-4 mb-2">
                    <label className="text-xs font-bold text-warm-700 mb-0">Criterios de evaluación</label>
                    <button
                      type="button"
