  ...
  return (
    <form onSubmit={handleSubmit} className="card-warm p-8 space-y-5 max-w-md w-full">
      ...
      <p className="text-base text-warm-700 leading-relaxed">
        {mode === 'login' ? (
          <>
            Entra para ver tu historial de clases y sincronizar tu listado en la nube.
            También puedes usar el cuaderno sin cuenta desde el inicio.
          </>
        ) : (
          <>
            Crea tu cuenta para guardar clases anteriores y tu listado de pequeños.
            No necesitas registrarte para preparar una clase y entrar al aula hoy.
          </>
        )}
      </p>
      ...
      <a
        href="/"
        className="block text-center text-base font-semibold text-warm-600 hover:text-coral-600"
      >
