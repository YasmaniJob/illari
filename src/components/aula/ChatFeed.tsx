        ...
        <div className="flex items-center justify-between gap-3 px-1 pb-3 mb-2 border-b border-warm-200">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] font-bold text-lilac-600 uppercase tracking-widest mt-0.5">Expediente de Observaciones</p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          {expedienteEntries.length === 0 && !sending && (
            <div className="h-full flex flex-col items-center justify-center text-center px-6 py-12">
              <span className="flex h-16 w-16 items-center justify-center rounded-3xl bg-lilac-100 text-3xl mb-4 shadow-sm border border-lilac-200/30 animate-pulse">📋</span>
